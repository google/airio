...
from airio._src.core import dataset_providers
...
from airio.pygrain import dataset_providers as pygrain_dataset_providers
...
class DatasetProvidersTest(absltest.TestCase):
  ...
  def test_get_dataset_with_task(self):
    ...
    task = pygrain_dataset_providers.GrainTask(
  ...
  def test_get_dataset_with_mixture(self):
    ...
    for i in range(2):
      tasks.append(
          pygrain_dataset_providers.GrainTask(
              name=f"test_task_{i}",
    ...
    mixture = pygrain_dataset_providers.GrainMixture(
        name="test_mix",
        tasks=tasks,
        proportions=[1.0, 1.0],
    )
    ds = dataset_providers.get_dataset(mixture, seed=0)
    expected = [
  ...
  def test_get_vocabularies_mixture_returns_correct_vocabularies(self):
    ...
    mix = pygrain_dataset_providers.GrainMixture(
        name="test_mix",
        tasks=tasks,
        proportions=[1.0, 0.5, 2.0],
    )
