...
class MapFnTransform(grain.MapTransform):
  ...
  map_fn: preprocessors_lib.MapFnCallable
  runtime_args: preprocessors_lib.AirIOInjectedRuntimeArgs | None = None
  update_runtime_args: preprocessors_lib.UpdateRuntimeArgsCallable | None = None


  def map(self, element):
    """Maps a single element."""
    return preprocessors_lib.inject_runtime_args_to_fn(
...
class RandomMapFnTransform(grain.RandomMapTransform):
  ...
  map_fn: preprocessors_lib.RandomMapFnCallable
  runtime_args: preprocessors_lib.AirIOInjectedRuntimeArgs | None = None
  update_runtime_args: preprocessors_lib.UpdateRuntimeArgsCallable | None = None
...
class FilterFnTransform(grain.FilterTransform):
  ...
  filter_fn: preprocessors_lib.FilterFnCallable
  runtime_args: preprocessors_lib.AirIOInjectedRuntimeArgs | None = None
  update_runtime_args: preprocessors_lib.UpdateRuntimeArgsCallable | None = None
  ...
  def __post_init__(self):
    ...
    if isinstance(self.transform, grain.RandomMapTransform) and not isinstance(
      ...
      raise ValueError(
          ...
          " airio.grain.preprocessors.RandomMapFnTransform instead."
      )
